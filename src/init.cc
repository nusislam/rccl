...
const char* ncclFuncStr[NCCL_NUM_FUNCTIONS+5] = { "AllGather", "AllReduce", "AllToAllPivot", "AllToAllGda", "AllToAllvGda", "AllToAllvGdaSm", "Broadcast", "Reduce", "ReduceScatter", "SendRecv"};
