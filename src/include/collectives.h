...
#define DECL5(func, algo, proto, devredop, type) \
  ...
  extern __global__ void NCCL_KERN_NAME(func, algo, proto, devredop, type)(struct ncclDevComm* comm, struct channelMasks channelMask, struct ncclWork* workHead); \
  extern __global__ void NCCL_KERN_NAME_DEBUG(func, algo, proto, devredop, type)(struct ncclDevComm* comm, struct channelMasks channelMask, struct ncclWork* workHead);
#else
#define DECL5(func, algo, proto, devredop, type) \
